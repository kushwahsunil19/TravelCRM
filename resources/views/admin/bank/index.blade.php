            ...
            <div class="content-page-header">
                ...
                <div class="list-btn">
                    <ul class="filter-list">
                        ...
                        <li>
                            <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#bank_details"><i
                                    class="fa fa-plus-circle me-2" aria-hidden="true" ></i>Add bank</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center table-hover datatable">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul>
                                                        <li>
                                                            <a class="dropdown-item edit_bank" data-id="{{$bank->id}}"><i
                                                                    class="far fa-edit me-2"  class="fe fe-edit "></i>Edit</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#delete_modal{{$bank->id}}"><i
                                                                    class="far fa-trash-alt me-2"></i>Delete</a>
                                                        </li>
                                                        <!-- <li>
																		<a class="dropdown-item" href="{{ route('banks.show', $bank->id) }}"><i class="far fa-eye me-2"></i>View</a>
																	</li> -->
                                                        <!-- <li>
                                            ...
                                            <!-- Delete Items Modal -->
                                            <div class="modal custom-modal fade" id="delete_modal{{$bank->id}}"
                                                role="dialog">
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="9" class="text-center">No bank found.</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
...
<!-- /Main Wrapper -->
<!-- Add bank_detail Modal -->
<div class="modal custom-modal modal-lg fade" id="bank_details" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
...
<div class="modal custom-modal modal-lg fade" id="edt_bank_details" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header border-0 pb-0">
                <div class="form-header modal-header-title text-start mb-0">
                    ...
                    <!-- Include CSRF token for security -->
                     ...
                     <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="input-block mb-3">
                                <label>Bank Name <span class="text-danger">*</span></label>
                                <input type="text" name="bank_name" id="edit_bank_name" class="form-control" placeholder="Enter Bank Name">
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="input-block mb-3">
                                <label>Account Number <span class="text-danger">*</span></label>
                                <input type="number" name="account_no" id="edit_account_no" class="form-control"
                                    placeholder="Enter Account Number">
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                        ...
                        <div class="col-lg-12 col-md-12 iban_no">
                            <div class="input-block mb-3">
                                <label>IBAN No <span class="text-danger"></span></label>
                                <input type="text" name="iban_no" id="edit_iban_no" class="form-control"
                                    placeholder="Enter IBAN No">
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.edit_bank', function() {
        ...
        $.ajax({
            url: '{{ route("banks.edit", ":id") }}'.replace(':id',
            ...
            success: function(response) {
                ...
                $('#bank_id').val(data.id); // Hidden user ID
    ...
    // Edit package
    $('#edit_bank_details_form').on('submit', function(e) {
        e.preventDefault(); // Prevent the form from submitting normally
       
        var formData = new FormData(this); // FormData for file uploads
        var id = $('#bank_id').val(); // Get user ID from hidden input
        $.ajax({
            url: '{{ route("banks.update", ":id") }}'.replace(':id', id), // Update route
            ...
            success: function(response) {
                ...
                // $('#edt_bank_details').modal('hide'); // Close modal after success
                setTimeout(function() {
                window.location.reload(); // Reload the page after the delay
               }, 3000);
            },
