...
@section('content')
		...
		<div class="main-wrapper login-body">
			...
			<div class="login-wrapper">
				<div class="container">
					<img class="img-fluid logo-dark mb-2" src="{{ url('public/assets/img/logo2.png')}}" alt="Logo">
					<img class="img-fluid logo-light mb-2" src="{{ url('public/assets/img/logo2-white.png')}}" alt="Logo">
