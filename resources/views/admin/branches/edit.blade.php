										...
										<div class="row">
												<div class="col-lg-6 col-md-6 col-sm-12">
													<div class="input-block mb-3">
														...
														<input type="text" class="form-control" name="branch_name" placeholder="Enter Name" value="{{ old('branch_name', $branch->branch_name) }}">
												...
												<div class="col-lg-6 col-md-6 col-sm-12">
													<div class="input-block mb-3">
														<label>City</label>
														<input type="text" class="form-control" name="city" value="{{ old('city', $branch->city) }}" placeholder="Enter City">
														@if ($errors->has('city'))
