                                            ...
                                            <div class="table-responsive itme_table no-pagination">
                                                <table class="table table-center table-hover datatable">
                                                    ...
                                                    <tbody id="packageBody">
                                                        @if(isset($invoice->package->package_name))
                                                        <tr>
                                                            ...
                                                            <td class="d-flex align-items-center">
                                                                ...
                                                                <a class="btn-action-icon me-2">
                                                                    <span><i data-id="{{ $invoice->package->id}}"
                                            ...
                                            <div class="form-group-bank">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-block mb-3">
                                                            ...
                                                            <select class="select" id="bank_id" name="bank_id">
                                                                ...
                                                                <option value="{{ $res->id }}"
                                                                    {{ (old('bank_id', $invoice->bank_id) == $res->id) ? 'selected' : '' }}>
                                                                    {{ $res->bank_name }}
                                                                </option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="input-block mb-3 notes-form-group-info">
                                                    ...
                                                    <textarea class="form-control" placeholder="Enter Notes"
                                                        name="note">{{ trim($invoice->note) }}</textarea>
                                                </div>
                                                <div class="input-block mb-3 notes-form-group-info mb-0">
                                                    <label>Terms and Conditions</label>
                                                    <textarea class="form-control"
                                                        placeholder="Enter Terms and Conditions"
                                                        name="term_condition">{{ trim($invoice->term_condition) }}</textarea>
                                ...
                                <ul class="form-group-plus css-equal-heights" style="float:right">
                                    <li>
                                        <a class="dropdown-item" target="_blank"
                                            href="{{route('invoice.preview',$invoice->id)}}"><i
                                                class="fe fe-eye me-2"></i>View</a>
                                    <li>
                                        <form method="GET" action="{{ route('invoice.estimate', $invoice->id) }}">
...
$(document).ready(function() {
    ...
    $(document).on('change', '#discount_type', function() {
        ...
        calculation(package_amt, vat, discount, discount_type);
    });
