...
<body>
    ...
    <div class="total" style="padding: 0px">
        <p> <strong>Sub Total :</strong> {{$data['curreny_symbol']}}{{ number_format($data['subtotal'], 2) }} </p>
        ...
        <p><strong>Invoice Total :</strong> {{$data['curreny_symbol']}}{{ number_format($data['total'], 2) }}</p>
