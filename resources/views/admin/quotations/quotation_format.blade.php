    ...
    <div class="container">
                    ...
                    <tr>
                        ...
                        <td style="width: 50%; vertical-align: top; text-align: right;">
                            <p>
                                ...
                                <b>Estimate Total({{ $currency_code }}):</b> {{ number_format($total, 2) }}
                            </p>
                        </td>
                    </tr>
                </table>
        ...
        <div class="total" style="padding: 0px">
            ...
            @php       
                    ...
                    @endphp
                    <strong>Estimate Total ({{ $currency_code }}) :</strong> <span id="total_in_aed">{{ number_format($subtotal,2) }}</span><br />

                    @foreach ($currency_totals as $currency => $amount)

                    @if ($currency !== $currency_code)
                    <strong>Estimate Total ({{ $currency }}) :</strong> <span id="total_in_usd"> {{ number_format($amount, 2) }} </span><br />
