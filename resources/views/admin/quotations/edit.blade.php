                                                    ...
                                                    <tbody id="packageBody">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <hr>
                                                                <strong>Net Total:
                                                                    {{ isset($quotation->package->net_amount) ? $quotation->package->net_amount : ''}}</strong>


                                                            </td> <!-- Amount -->
                                                            <td>
                                                                {{ 
                                                                                                                        isset($quotation->package->amount, $quotation->package->net_amount) 
                                                                                                                        ? number_format($quotation->package->amount - $quotation->package->net_amount, 2) 
                                                                                                                        : '0.00' 
                                                                                                                    }}
                                                            </td>
                                                            <td>
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-block mb-3">
                                                            ...
                                                            <select class="select" id="bank_id" name="bank_id">
                                                                ...
                                                                <option value="{{ $res->id }}"
                                                                    {{ (old('bank_id', $quotation->bank_id) == $res->id) ? 'selected' : '' }}>
                                                                    {{ $res->bank_name }}
                                                                </option>
                                                                @endforeach
                                                            </select>
