                        ...
                        <form action="{{ route('quotations.update', $quotation->id) }}" method="POST"
                            ...
                            <div class="form-group-item">
                                        ...
                                        <div class="input-block mb-3">
                                            ...
                                            <select name="partner_id" id="partner_id" class="form-control" required>
                                                ...
                                                <option value="{{ $partner->id }}"
                                                    {{ (old('partner_id', $quotation->partner_id) == $partner->id) ? 'selected' : '' }}>
                                                    {{ $partner->name }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="input-block mb-3">
                                            ...
                                            <input type="number" class="form-control" name="quotation_no"
                                                ...
                                                value="{{ old('quotation_no', $quotation->quotation_no) }}" readonly>
                                    ...
                                    <!-- <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="input-block mb-3">
                                            ...
                                            <input type="number" class="form-control" name="twin_double_sharing_cost"
                                                ...
                                                value="{{ old('discount', $quotation->twin_double_sharing_cost) }}">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="input-block mb-3">
                                            ...
                                            <input type="number" class="form-control" name="triple_sharing_cost"
                                                ...
                                                value="{{ old('quotation_no', $quotation->triple_sharing_cost) }}">
                                                ...
                                                <table class="table table-center table-hover datatable">
                                                    ...
                                                    <tbody id="packageBody">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <!-- Description -->
                                                            <td>{{ $quotation->package->amount}}</td> <!-- Amount -->
                                                ...
                                                <div class="form-group-bank">
                                                    <div class="invoice-total-box">
                                                        ...
                                                        <div class="invoice-total-footer">
                                                            ...
                                                            // Calculate tax amount (tax percentage applied to the
                                                        
                                                            $tax_amt = ($amount_after_discount ) / 100;
                                                            ...
                                                            <h4>Total Amount <span
                                                                    class="total_amt">${{$total_amt}}</span></h4>
                                                        </div>
                                                    </div>
                                                    <!-- <div class="input-block mb-3">
                                ...
                                <div class="add-customer-btns text-end">
                                    ...
                                    <button type="submit" class="btn customer-btn-save">Preview</button>
...
<!-- Edit User Modal -->
<div class="modal custom-modal modal-lg fade" id="edit_model" role="dialog">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="input-block mb-3">
                                            ...
                                            <input type="text" class="form-control" id="package_name"
                                                placeholder="Enter First Name" name="package_name" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="input-block mb-3">
                                            ...
                                            <input type="text" class="form-control" id="amount"
                                                placeholder="Enter Last Name" name="amount" required>
                                        </div>
                                    </div>
...
$(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        const editRoute = '{{ route("packages.edit", ":id") }}'.replace(
                            ':id', packageData.id);
    ...
    $(document).on('click', '.fe-edit', function() {
