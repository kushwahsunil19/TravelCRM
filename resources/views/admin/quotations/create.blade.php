                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-6 col-sm-12">
                                                    <div class="input-block mb-3">
                                                        ...
                                                        <select class="select form-control" name="currency_id"
                                                            id="currency_id" onchange="updateCurrencyRate(this)"
                                                            required>
                                                            <option value="">Select Currency</option>
                                                            <option value="1" data-id="INR" data-symbol="₹">INR</option>
                                                            <option value="4" data-id="AED" data-symbol="د.إ">AED
                                                            </option>
                                                            <option value="3" data-id="EUR" data-symbol="€">EUR</option>
                                                        </select>
                                                        @if ($errors->has('currency_id'))
                                                            <span
                                                                class="text-danger">{{ $errors->first('currency_id') }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <script>
                                                ...
                                                async function updateCurrencyRate(selectElement) {
                                                    ...
                                                    const targetCurrency = selectedOption.getAttribute('data-id');
