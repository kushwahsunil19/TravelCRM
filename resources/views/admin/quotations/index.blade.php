						...
						<div class="content-page-header">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
										<a class="btn btn-primary" href="{{route('quotations.create')}}"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Create Quotation</a>
									</li>
								</ul>
							</div>
						</div>
							...
							<div class="card-table"> 
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $quotation->branch->city }}</td>
                                        <td>{{ $quotation->package->package_name }}</td>

                                        <td>{{ $quotation->partner->name }}</td>
