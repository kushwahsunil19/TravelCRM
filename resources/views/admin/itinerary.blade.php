						...
						<div class="content-page-header ">
							...
							<div class="list-btn">
								<ul class="filter-list">
									...
									<li>
										<a class="btn btn-primary" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_user"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Add Itinerary</a>
									</li>
								</ul>
							</div>
						</div>
...
$(document).on('click', '.edit-user', function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#user_id').val(response.id); // Hidden user ID
            ...
            $('#edit_status').val(response.status).change(); // Assuming 'status' is 1 or 0

            // Handle profile image
			if (response.profile) {
                // Set the profile image source
                $('#blahedit').attr('src', '{{ url("public/profile") }}/' + response.profile);
            } else {
