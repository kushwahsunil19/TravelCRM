						...
						<div class="card">
							<div class="card-body">
								...
								<div class="progress progress-sm mt-3">
									<div class="progress-bar bg-6" role="progressbar" style="width:{{$userCount}}%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
								</div>
					...
					<div class="col-xl-4 col-sm-6 col-12">
						<div class="card">
							<div class="card-body">
								...
								<div class="progress progress-sm mt-3">
									<div class="progress-bar bg-7" role="progressbar" style="width: {{$totalInvoice}}%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
								</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="dash-widget-header">
									...
									<div class="dash-count">
										<div class="dash-title">Total Estimates</div>
										<div class="dash-counts">
											<p>{{$totalEstimate}}</p>
										</div>
									</div>
								...
								<div class="progress progress-sm mt-3">
									<div class="progress-bar bg-8" role="progressbar" style="width: {{$totalEstimate}}%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
								</div>
