            ...
            <div class="content-page-header">
                ...
                <div class="list-btn">
                    <ul class="filter-list">
                        ...
                        <li>
                            <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#currency_details"><i
                                    class="fa fa-plus-circle me-2" aria-hidden="true" ></i>Add Currency</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center table-hover datatable">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul>
                                                        <li>
                                                            <a class="dropdown-item edit_currency" data-id="{{$currency->id}}"><i
                                                                    class="far fa-edit me-2"  class="fe fe-edit "></i>Edit</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#delete_modal{{$currency->id}}"><i
                                                                    class="far fa-trash-alt me-2"></i>Delete</a>
                                                        </li>
                                                        <!-- <li>
																		<a class="dropdown-item" href="{{ route('currencies.show', $currency->id) }}"><i class="far fa-eye me-2"></i>View</a>
																	</li> -->
                                                        <!-- <li>
                                            ...
                                            <!-- Delete Items Modal -->
                                            <div class="modal custom-modal fade" id="delete_modal{{$currency->id}}"
                                                role="dialog">
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="9" class="text-center">No Currency found.</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
...
<!-- /Main Wrapper -->
<!-- Add currency_detail Modal -->
<div class="modal custom-modal modal-lg fade" id="currency_details" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header border-0 pb-0">
                <div class="form-header modal-header-title text-start mb-0">
                    <h4 class="mb-0">Add Currency Details</h4>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="currency_details_form" action="{{ route('currencies.store') }}" method="POST"
...
<!-- /Add currency_detail Modal -->
 <!-- Edit currency detail Modal -->
<div class="modal custom-modal modal-lg fade" id="edt_currency_details" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
            <div class="modal-header border-0 pb-0">
                <div class="form-header modal-header-title text-start mb-0">
                    <h4 class="mb-0">Edit Currency Details</h4>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            
                    <form id="edit_currency_details_form" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="input-block mb-3">
                                <label>Code</label>
                                <input type="text" class="form-control" name="code" id="edit_code" placeholder="Enter Code">
                                @if ($errors->has('code'))
                                <span class="text-danger">{{ $errors->first('code') }}</span>
                                @endif
                            </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="input-block mb-3">
                                <label>Symbol</label>
                                <input type="text" class="form-control" name="symbol" id="edit_symbol" placeholder="Enter Symbol">
                                @if ($errors->has('symbol'))
                                <span class="text-danger">{{ $errors->first('symbol') }}</span>
                                @endif
                            </div>
...
$(document).ready(function() {
    ...
    $('#currency_details_form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                // $('#currency_details').modal('hide'); // Close modal
                $('#currency_details_form')[0].reset(); // Reset the form
                setTimeout(function() {
    ...
    $(document).on('click', '.edit_currency', function() {
        ...
        $.ajax({
            url: '{{ route("currencies.edit", ":id") }}'.replace(':id',
            ...
            success: function(response) {
                ...
                $('#currency_id').val(data.id); // Hidden user ID
                ...
                // }
                // Open the modal
                $('#edt_currency_details').modal('show');
            },
            error: function(xhr) {
    ...
    // Edit package
    $('#edit_currency_details_form').on('submit', function(e) {
        e.preventDefault(); // Prevent the form from submitting normally
       
        var formData = new FormData(this); // FormData for file uploads
        var id = $('#currency_id').val(); // Get user ID from hidden input
        $.ajax({
            url: '{{ route("currencies.update", ":id") }}'.replace(':id', id), // Update route
            ...
            success: function(response) {
                ...
                // $('#edt_currency_details').modal('hide'); // Close modal after success
                setTimeout(function() {
                window.location.reload(); // Reload the page after the delay
               }, 3000);
            },
