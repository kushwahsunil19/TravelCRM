				...
				<div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<nav class="greedys sidebar-horizantal">
							<ul class="list-inline-item list-unstyled links">
								...
								<li class="submenu">
									...
									<ul>
										<li>  <a   href="leads.php"  class="active"><i class="fe fe-users"></i> <span>Leads </span></a></li>
										<li>
										<li>  <a   href="customers.php"  class="active"><i class="fe fe-users"></i> <span>Customers </span></a></li>
										<li>
						...
						<ul class="sidebar-vertical">
							...
							<li>
								<a href="leads.php" class="active"><i class="fe fe-users"></i> <span>Leads</span></a>
							</li>
							<li>
								<a href="lead_interaction.php" class="active"><i class="fe fe-users"></i> <span>Leads Interaction</span></a>
							</li>
							<li>
								<a href="lead_followup.php" class="active"><i class="fe fe-users"></i> <span>Leads Followups</span></a>
							</li>
							<li>
								<a href="sales_representative.php" class="active"><i class="fe fe-users"></i> <span>Sales Representative</span></a>
							</li>
							<li>
								<a href="products.php" class="active"><i class="fe fe-users"></i> <span>Products</span></a>
							</li>
							<li>
								<a href="quotations.php" class="active"><i class="fe fe-users"></i> <span>Quotation</span></a>
							</li>
